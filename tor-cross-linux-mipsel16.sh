...
# Build Zlib:
	cd zlib-1.2.11
    export CC="mipsel-linux-gnu-gcc -mips16 -static"
...
# Build libevent !!!!!!!!!!! (PROBLEME BEGINNEN HIER !!!!!! <--- BESTIMMT !!!!):
    ...
    export CC="mipsel-linux-gnu-gcc -mips16" 
...
# Build Tor:
    ...
    ./configure --enable-static-tor --host=mipsel-linux-gnu-gcc --prefix="$HOME/tor/install" --with-libevent-dir="/libevent-2.1.11-stable/install/" --with-openssl-dir="/openssl-1.0.2j/install/" --with-zlib-dir="/zlib-1.2.11" --disable-tool-name-check
